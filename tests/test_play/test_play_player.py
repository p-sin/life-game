...
#     """Tests that the outputs are card objects by checking they are a dict with a
#     "slot_number" key"""
#     deals = test_deals
...
# @pytest.mark.parametrize(
#     "card_1, card_2, slot_1, type_1, value_1, slot_2, type_2, value_2, slot_3,"
#     "type_3, value_3",
#     [
#         (
#             1,
...
#     value_3,
# ) -> None:
#     """Test that the chosen cards are correctly applied to the player board over a
#     single turn"""
#     players = create_players(1, test_deals)
#     chosen_cards = [cards[card_1], cards[card_2]]
#     players[1].play_cards(chosen_cards)

#     # Two cards played each time. Updates a test version of board below and compares to
#     # actual board
...
#     """Test that the chosen cards are correctly applied to the player board over
#     multiple turns"""
...
#     player, round, hand, card_order, outcome_1, outcome_2, outcome_3, outcome_4
# ) -> None:
#     """Tests that the correct cards are removed from the player's hand across several
#     turns"""
#     players = create_players(2, test_deals_2)

#     # Simulates turns by having it select different values from the 'card_order'. Each
#     # loop
#     # is a new turn and it changes the definition of card_1 and card_2 - functionally
#     # just
...
#         # Get all the card numbers from the hand and check against the expected outcome
#         # for
#         # this turn
...
#     player, card_1, card_2, card_3, card_4, card_5, card_6, attribute, value
# ) -> None:
#     """Tests that each player's attribute totals are correctly updated after playing
#     several cards"""
#     # The test repeats the same process for each player and attribute, but only tests
#     # one attribute
#     # on each iteration
#     players = create_players(player, test_deals)
#     chosen_cards = [cards[card_1], cards[card_2]]
