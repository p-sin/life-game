...
# from life_game.play.players import Player, create_players
...
# from tests.utils import adol_deal, adult_deal, child_deal
...
#     """Tests that the card phase method runs correctly by checking that 2 cards have
#     been removed
#     from the player hand (shows the remove_cards process was called). Does not need to
#     test further
...
#     """Tests that the card phase method runs correctly by checking that no player has 0
#     for all of their
#     attributes. Shows the updating of the attributes process was called. Does not need
#     to test further
#     as the individual method has already been tested"""
#     deals = deal_cards(6)
#     players = create_players(6, deals)
...
#     """Tests the pass_hand method runs corectly by checking that each player has the
#     expected (switched)
#     hand."""
...
#     """Tests that the play turn method calls the correct functions. Mocks the function
#     calls
#     and validates that each one is called"""
#     players = create_players(6, test_deals)
#     events = deal_events()
#     game = Game(6, players, events)
#     # Create a mock version of the function, which can then be checked to see if it was
#     # called
