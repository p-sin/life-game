...
#     ],
# )
# def test_attribute_enum_defined(enum: str, name: str, value: int) -> None:
...
#     ],
# )
# def test_attribute_slots_defined(slot: int) -> None:
...
#     ],
# )
# def test_board_defined(attribute: str, value: Any) -> None:
...
#     ],
# )
# def test_total_cards_in_decks(deck: str, total: int) -> None:
...
# )
# def test_event_deck_total(round: str, total: int) -> None:
