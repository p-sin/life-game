...
# def test_deal_correct_rounds(round: str) -> None:
...
#     ],
# )
# def test_deal_correct_num_cards(round: str, total_players: int, num_cards: int) -> None:
...
# @pytest.mark.parametrize("round", [("child"), ("adol"), ("adult")])
# def test_deal_cards_from_correct_round(round: str) -> None:
...
# @pytest.mark.parametrize("round", [("child"), ("adol"), ("adult")])
# def test_event_deal_correct_rounds(round: str) -> None:
...
# @pytest.mark.parametrize("round", [("child"), ("adol"), ("adult")])
# def test_event_deal_correct_num_cards(round: str) -> None:
...
# @pytest.mark.parametrize("round", [("child"), ("adol"), ("adult")])
# def test_deal_event_cards_from_correct_round(round: str) -> None:
...
# @pytest.mark.parametrize("round", [("child"), ("adol"), ("adult")])
# def test_deal_event_cards_duplicates(round: str) -> None:
